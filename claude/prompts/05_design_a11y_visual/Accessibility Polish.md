...
- Implementation mode: change the repository when a focused accessibility improvement is justified by current evidence.
...
- If the user named a route, component, form, modal, table, keyboard issue, screen-reader issue, or accessibility audit work item, polish that owner and directly affected states.
