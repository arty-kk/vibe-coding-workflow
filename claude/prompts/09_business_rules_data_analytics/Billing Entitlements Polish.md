...
- Implementation mode: change the repository when a focused billing/entitlement improvement is justified by current evidence.
...
- If the user named a plan gate, quota, webhook, provider mapping, billing flow, permission issue, or audit work item, improve that owner and directly affected surfaces.
