...
- Execute/documentation mode: add or improve one repository-native visual regression or screenshot review path when current evidence justifies it.
...
- If the user named a route, component, story, screenshot gap, or UI audit task-sub, target that surface and its critical states.
