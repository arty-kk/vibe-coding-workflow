...
- Execute mode: change the repository when a focused notification/email improvement is justified by current evidence.
...
- If the user named an email, template, notification, toast, reminder, recipient, trigger, or audit task-sub, polish that owner and directly affected producers/consumers.
