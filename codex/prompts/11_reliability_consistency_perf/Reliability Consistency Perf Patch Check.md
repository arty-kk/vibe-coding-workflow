...
- Review mode only: inspect the current diff and affected repository evidence, do not edit product code.
...
Produce native Codex Cloud task-subs only for actionable P0/P1/P2 regressions. If no regressions qualify, output `No actionable reliability/consistency/performance regressions found` plus the checks/evidence reviewed.
